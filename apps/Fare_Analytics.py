...
app.title = "SimplyOR Analytics Dashboard"
#
# app.config['suppress_callback_exceptions'] = True

# df_fare_comp = pd.read_csv("https://raw.githubusercontent.com/varunrishi2006/render-fareanalytics-app/main/fare_comp.csv")
df_fare_comp = pd.read_csv(DATA_PATH.joinpath("fare_comp.csv"))
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.Div(
                                    [html.H5(id="departureText1"), html.P("AA Departures (Sector)")],
                                    # id="departures",
                                    className="mini_container",
                                    style={'padding': '0px 10px', 'textAlign': 'center', 'fontWeight': 'bold',
                                           'backgroundColor': 'lightgrey'}
...
@app.callback(
    [
        ...
        Output("departureText1", "children"),
